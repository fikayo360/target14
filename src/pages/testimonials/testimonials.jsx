...
export function Testimonials(){
    return(
        <section id='testimonials'>
            ...
            <div className='testimonial'>
                ...
                <div className='testiUp'>
                    ...
                    Working with sarah was an absolute delight! Their creative vision brought my ideas to life, and the results were beyond my expectations. 
            ...
            <div className='testiUp'>
                ...
                <p className='testiDown'>Incredible talent and a true professional! sarah has an exceptional ability to capture the essence of a moment.
                </p>

                <p className='testiDown'>Every photo tells a story, and the creativity behind each shot is truly impressive. 
                I couldn't be happier with the stunning images they produced for my special event.
                    </p>
        </div>
        ...
        <div className='testimonial'>
            ...
            <div className='testiUp'>
                <img src='https://110sol.weebly.com/uploads/1/0/9/4/109453127/dusk-profile-3_2.jpg' />
                <div className='testiUpCol'>
                    <h2> jason clark </h2>
                    <h1>@wins kitchen </h1>
                </div>
                ...
                <p className='testiDown'>
                What sets this photographer apart is their keen eye for detail, a distinctive approach to composition, and an innate sense of timing. Every photo reflects a deep understanding of the subject, creating a visual tapestry that goes beyond mere documentation. 
                It's as if they possess a magical ability to transform ordinary scenes into cinematic masterpieces.
                </p>

                <p className='testiDown'>
                During the photoshoot, they effortlessly created an atmosphere of comfort and ease, encouraging genuine expressions and authentic moments. 
                The collaborative spirit was evident as they seamlessly integrated their creative vision with my preferences, resulting in a collection of images that felt 
                not only visually stunning but deeply personal
                </p>
        </div>
        ...
        <div className='testimonial'>
            ...
            <div className='testiUp'>
                <img src='https://usa.bootcampcdn.com/wp-content/uploads/sites/33/2021/04/Screen-Shot-2020-10-27-at-2.03.13-PM.png' />
                <div className='testiUpCol'>
                    <h2> thomas wilkes </h2>
                    <h1>@tom-00 </h1>
                </div>
                ...
                <p className='testiDown'>A master of their craft! sarah has an extraordinary eye for composition and lighting. 
                The photos they took for our project were nothing short of amazing. 
                </p>

                <p className='testiDown'>Their ability to turn ordinary scenes into extraordinary works of art is unparalleled.
                 I'm genuinely grateful for their expertise
                </p>
        </div>
        ...
        <div className='testimonial'>
           ...
           <div className='testimonial'>
                ...
                <div className='testiUp'>
                    <img src='https://qph.cf2.quoracdn.net/main-thumb-967783910-200-lypvkmebfgqvavrppbwblvmwygusecir.jpeg' />
                    <div className='testiUpCol'>
                        <h2> john smith </h2>
                        <h1>@john-2 </h1>
                    </div>
                    ...
                    <p className='testiDown'>The passion and dedication they bring to their work are evident in every shot. Our wedding photos are nothing short of spectacular,
                     and we are forever grateful for the memories they've beautifully preserved.
                    </p>
            </div>
